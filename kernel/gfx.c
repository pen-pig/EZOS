...
void gfx_restore_text(void) {
    ...
    outb(0x3D4, 0x0C); outb(0x3D5, 0x00);   /* start_addr = 0x0000£ºÎÄ±¾Ä£Ê½ÏÔ´æ´Ó 0xB8000 Æğ */
    outb(0x3D4, 0x0D); outb(0x3D5, 0x00);   /* ¾ÉµÄ 0xC000 ³¬³ö 32KB Ò³(0x8000)£¬Ïàµ±ÓÚ°ÑÏÔÊ¾Æğµã
                                               Ö¸µ½³Â¾É VRAM/Í¼ĞÎ²ĞÁôÉÏ£¬·µ»ØÎÄ±¾Ä£Ê½ºóÕûÆÁ²ÊÉ«Ìõ */
    outb(0x3D4, 0x0E); outb(0x3D5, 0x00);
    outb(0x3D4, 0x0F); outb(0x3D5, 0x00);
