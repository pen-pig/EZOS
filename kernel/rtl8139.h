/*
 * rtl8139.h - Realtek RTL8139 网卡驱动（步骤 7 网络）
 *
 ...
 *           ARP request 应答 + ICMP echo reply（可被 ping）
 *
...
uint32_t rtl8139_arp_replied(void);   /* ARP request 应答数 */
uint32_t rtl8139_icmp_replied(void);  /* ICMP echo reply 数 */
