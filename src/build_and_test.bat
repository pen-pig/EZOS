...
echo [4/6] 链接内核...
"%LD%" %LDFLAGS% -o kernel_raw.bin boot\kernel_entry.o kernel\kernel.o kernel\tty.o kernel\idt.o kernel\isr.o kernel\keyboard.o kernel\ata.o kernel\shell.o kernel\exfat.o kernel\gui.o kernel\mouse.o kernel\gfx.o
if errorlevel 1 goto error
...
:clean
echo 正在清理构建产物...
del /q boot\boot.bin boot\kernel_entry.o kernel\kernel.o kernel\tty.o kernel\idt.o kernel\isr.o kernel\keyboard.o kernel\ata.o kernel\shell.o kernel\exfat.o kernel\gui.o kernel\gfx.o kernel_raw.bin kernel.bin os-image.bin 2>nul
echo 清理完成！
pause
exit /b 0
